    ...
    <aside className="w-64 min-h-screen bg-slate-900 flex flex-col">
      ...
      <div className="px-6 py-5 border-b border-slate-700">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-white text-sm font-semibold leading-tight">1095-C Toolkit</p>
            <p className="text-slate-400 text-xs leading-tight">ABC Janitorial Services</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-slate-700">
        {userEmail && (
          <p className="text-slate-400 text-xs px-3 mb-2 truncate">{userEmail}</p>
        )}
        <button
