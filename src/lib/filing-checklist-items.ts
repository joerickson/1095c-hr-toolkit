...
export function getFilingChecklist(taxYear: number): FilingChecklistItem[] {
  ...
  const items: ItemDef[] = [
    ...
    // SYS: Company Setup
    {
      ...
      detail: `Navigate to Insurance Benefits > Defaults > Defaults tab > ACA Settings section (bottom right of screen). Verify the Affordable Care Act Configuration checkbox was checked for tax year ${priorYear}. This is required before any 1095-C forms can be generated.`,
      winteamPath: 'Insurance Benefits > Defaults > Defaults tab > ACA Settings section > Affordable Care Act Configuration checkbox',
      severity: 'critical',
      isGate: true,
      order: 1,
    },
    {
      ...
      detail: `Confirm the Employer Identification Number in WinTeam (labeled Federal ID) exactly matches your IRS records. An incorrect EIN will cause the IRS to reject the entire 1094-C/1095-C filing.`,
      winteamPath: 'SYS > Company Setup > Federal ID field',
      severity: 'critical',
      isGate: true,
      order: 2,
    },
    {
      ...
      detail: `Verify the contact phone number in SYS > Company Setup > Insurance Benefits 1095-C section (bottom right) is a current, working number for your HR department. The IRS may use this number to contact you about your filing.`,
      winteamPath: 'SYS > Company Setup > Insurance Benefits 1095-C section > Contact Phone field (bottom right of Company Setup)',
      severity: 'required',
      isGate: true,
      order: 3,
    },
    ...
    // INS: Eligibility Setup
    {
      ...
      detail: `In Insurance Benefits > Eligibility Setup, open each eligibility rule used for ${priorYear} and confirm the "ACA Compliant Eligibility" checkbox is checked. Without this, WinTeam will not correctly calculate offer-of-coverage status.`,
      winteamPath: 'Insurance Benefits > Eligibility Setup > ACA Compliant Eligibility checkbox',
      severity: 'critical',
      isGate: true,
      order: 4,
    },
    {
      ...
      phase: 1,
      section: `Audit ${priorYear} — INS: Eligibility Setup`,
      label: `Plan Year Start Month is set to '01' in INS: Defaults ACA Settings`,
      detail: `Verify Plan Year Start Month is set to 01 in Insurance Benefits > Defaults > Defaults tab > ACA Settings section (bottom right). This tells WinTeam your plan year runs January–December, which is required for accurate ACA Line 14/15/16 calculations.`,
      winteamPath: 'Insurance Benefits > Defaults > Defaults tab > ACA Settings section > Plan Year Start Month field',
      severity: 'critical',
      isGate: true,
      order: 5,
    },
    ...
    // Plan 1 — MEC
    {
      ...
      detail: `In Insurance Benefits > Benefit Setup, open Plan 1. On the Pricing Tab, confirm the "ACA" checkbox is checked. This designates Plan 1 as an ACA-reportable plan.`,
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 1] > Pricing Tab > ACA checkbox',
      severity: 'critical',
      isGate: true,
      order: 6,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 1] > Pricing Tab > Self Insured checkbox',
      severity: 'critical',
      isGate: true,
      order: 7,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 1] > Pricing Tab > Minimum Value checkbox',
      severity: 'critical',
      isGate: true,
      order: 8,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 1] > Pricing Tab > Employee premium field',
      severity: 'critical',
      isGate: true,
      order: 9,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 1] > Plan Options Tab',
      severity: 'critical',
      isGate: true,
      order: 10,
    },
    ...
    // Plan 2 — Self-Insured
    {
      ...
      detail: `In Insurance Benefits > Benefit Setup, open Plan 2. On the Pricing Tab, confirm "ACA" is checked.`,
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 2] > Pricing Tab > ACA checkbox',
      severity: 'critical',
      isGate: true,
      order: 11,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 2] > Pricing Tab > Self Insured checkbox',
      severity: 'critical',
      isGate: true,
      order: 12,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 2] > Pricing Tab > Minimum Value checkbox',
      severity: 'critical',
      isGate: true,
      order: 13,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 2] > Plan Options Tab',
      severity: 'critical',
      isGate: true,
      order: 14,
    },
    ...
    // Plan 3 — Select Health
    {
      ...
      detail: `In Insurance Benefits > Benefit Setup, open Plan 3. On the Pricing Tab, confirm "ACA" is checked.`,
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 3] > Pricing Tab > ACA checkbox',
      severity: 'critical',
      isGate: true,
      order: 15,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 3] > Pricing Tab > Self Insured checkbox',
      severity: 'critical',
      isGate: true,
      order: 16,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 3] > Pricing Tab > Minimum Value checkbox',
      severity: 'critical',
      isGate: true,
      order: 17,
    },
    {
      ...
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 3] > Plan Options Tab',
      severity: 'critical',
      isGate: true,
      order: 18,
    },
    ...
    // Benefit Packages
    {
      ...
      detail: `This is the most common error causing incorrect 1095-C output. In Insurance Benefits > Benefits by Employee, open the Package Tab for a sample of employees. Each package must include Plan 1 AND Plan 2 AND Plan 3 — not just the plan the employee enrolled in. If only Plan 1 is in the package, WinTeam generates Line 14 code 1F (minimum essential coverage, not minimum value) instead of 1E (minimum value coverage). This affects every form in your filing.`,
      winteamPath: 'Insurance Benefits > Benefits by Employee > Package Tab > review package contents',
      severity: 'critical',
      isGate: true,
      order: 19,
    },
    ...
    // Preview Report Validation
    {
      ...
      winteamPath: `Insurance Benefits > ACA/1095-C Tools > Employee 1095-C Report > Tax Year ${priorYear} > Output Type: Preview`,
      severity: 'critical',
      isGate: true,
      order: 20,
    },
    ...
    },
    {
      ...
      detail: `In WinTeam Insurance Benefits > Defaults > Defaults tab > ACA Settings section (bottom right), update the tax year to ${taxYear}. This is required before running the ${taxYear} Eligibility Testing Wizard or generating ${taxYear} 1095-C forms.`,
      winteamPath: 'Insurance Benefits > Defaults > Defaults tab > ACA Settings section',
      severity: 'critical',
      isGate: true,
      order: 2,
    },
    ...
    },
    {
      ...
      detail: `Verify the Plan 1 employee-only monthly premium is correct for ${taxYear}. Update it in two places: (1) Insurance Benefits > Benefit Setup > Plan 1 > Pricing Tab, and (2) the App Settings page in this application. Both must match for Line 15 to be accurate.`,
      winteamPath: 'Insurance Benefits > Benefit Setup > [Plan 1] > Pricing Tab > Employee premium field',
      severity: 'critical',
      isGate: true,
      order: 5,
    },
    {
      ...
      detail: `In Insurance Benefits > Eligibility Testing Wizard, run the wizard for tax year ${taxYear}. This processes all employees through your eligibility rules and determines who must be offered coverage for ${taxYear}. Review the output for any unexpected results.`,
      winteamPath: `Insurance Benefits > Eligibility Testing Wizard > run for ${taxYear}`,
      severity: 'critical',
      isGate: true,
      order: 6,
    },
    {
      ...
      detail: `After running the Eligibility Wizard, assign the ${taxYear} benefit package to all employees identified as eligible. Each package must include all three plans. Check Insurance Benefits > Benefits by Employee for each eligible employee.`,
      winteamPath: 'Insurance Benefits > Benefits by Employee > Package Tab > review package contents',
      severity: 'critical',
      isGate: true,
      order: 7,
    },
    {
      ...
      detail: `For employees who were full-time all of ${taxYear - 1} and continue into ${taxYear}, their Stability Start Date should be January 1, ${taxYear}. Review Insurance Benefits > Benefits by Employee for year-round employees and confirm stability dates are correct.`,
      winteamPath: 'Insurance Benefits > Benefits by Employee > Package Tab > review package contents',
      severity: 'required',
      isGate: true,
      order: 8,
    ...
    },
    {
      ...
      detail: `For every employee enrolled in Plan 1 (MEC) during ${taxYear}, verify their enrollment is entered in Insurance Benefits > Benefits by Employee with the correct coverage start and end dates.`,
      winteamPath: null,
      severity: 'critical',
      isGate: false,
      order: 4,
...

    {
      ...
      detail: `In Insurance Benefits > ACA/1095-C Tools > Employee 1095-C Report, set Tax Year to ${taxYear} and Output Type to "1095-C Forms (preview)". Run for all employees. This generates the full set of draft forms for review before electronic filing.`,
      winteamPath: `Insurance Benefits > ACA/1095-C Tools > Employee 1095-C Report > Tax Year ${taxYear} > Output Type: 1095-C Forms (preview)`,
      severity: 'critical',
      isGate: true,
      order: 1,
    },
    ...
    },
    {
      ...
      detail: `In Insurance Benefits > ACA/1095-C Tools > Employee 1095-C Report, change Output Type to "1095-C Electronic File" and generate the file. Save the output file securely — this is the file you will submit to the IRS.`,
      winteamPath: 'Insurance Benefits > ACA/1095-C Tools > Employee 1095-C Report > Output Type: 1095-C Electronic File',
      severity: 'critical',
      isGate: true,
      order: 9,
    },
