    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
              ...
              return (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-red-800">{t('accessNeeded')}: WinTeam Administrator</p>
              ...
              return (
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <div className="flex items-start gap-2">
                    <span className="text-base flex-shrink-0">👤</span>
                    <div>
                      <p className="text-sm font-semibold text-purple-800">{t('accessNeeded')}: HR Manager</p>
              ...
              return (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-2">
                    <span className="text-base flex-shrink-0">👤</span>
                    <div>
                      <p className="text-sm font-semibold text-blue-800">{t('accessNeeded')}: Standard HR</p>
                      {access.delegation_notes && (
        ...
        <div className="flex items-center gap-3 px-6 py-4 border-t border-gray-100 bg-white rounded-b-xl">
          ...
          >
            {isComplete ? "Already Complete ✓" : isPending ? tCommon('loading') : tCommon('markCompleteAndClose')}
          </button>
        </div>
      </div>
    </div>
