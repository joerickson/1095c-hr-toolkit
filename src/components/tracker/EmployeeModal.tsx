    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-start justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl my-8">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <input value={form.city} onChange={(e) => set("city", e.target.value)}
                className="px-3 py-2 border border-gray-300 rounded-md text-sm" placeholder="City" />
              ...
              <input value={form.zip} onChange={(e) => set("zip", e.target.value)}
                className="px-3 py-2 border border-gray-300 rounded-md text-sm" placeholder="ZIP" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Plan Enrolled</label>
              <select value={form.plan_enrolled} onChange={(e) => set("plan_enrolled", e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                <option value="">— Not Set —</option>
                <option value="P1">Plan 1 — MEC (self-insured)</option>
                <option value="P2">Plan 2 — Self-Insured Full</option>
                <option value="P3">Plan 3 — Select Health</option>
                <option value="declined">Declined all plans</option>
              </select>
            </div>
            <div>
